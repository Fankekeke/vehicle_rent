<template>
  <a-card :bordered="false" class="card-area">
    ...
    <brand-add
      v-if="brandAdd.visiable"
      @close="handlebrandAddClose"
      @success="handlebrandAddSuccess"
      :brandAddVisiable="brandAdd.visiable">
    </brand-add>
    <brand-edit
      ref="brandEdit"
      @close="handlebrandEditClose"
      @success="handlebrandEditSuccess"
      :brandEditVisiable="brandEdit.visiable">
    </brand-edit>
  </a-card>
</template>
...
export default {
  name: 'brand',
  components: {brandAdd, brandEdit, RangeDate},
  data () {
    return {
      advanced: false,
      brandAdd: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/brand-info/' + ids).then(() => {
