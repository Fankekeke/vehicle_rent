...
public class OrderEvaluateServiceImpl extends ServiceImpl<OrderEvaluateMapper, OrderEvaluate> implements IOrderEvaluateService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectOrderEvaluatePage(Page<OrderEvaluate> page, OrderEvaluate orderEvaluate) {
        return baseMapper.selectOrderEvaluatePage(page, orderEvaluate);
    }
}
