...
public class PaymentRecordServiceImpl extends ServiceImpl<PaymentRecordMapper, PaymentRecord> implements IPaymentRecordService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectPayRecordPage(Page<PaymentRecord> page, PaymentRecord paymentRecord) {
        return baseMapper.selectPayRecordPage(page, paymentRecord);
    }
}
