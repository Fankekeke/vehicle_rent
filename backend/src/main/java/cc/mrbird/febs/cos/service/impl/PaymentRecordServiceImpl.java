...
public class PaymentRecordServiceImpl extends ServiceImpl<PaymentRecordMapper, PaymentRecord> implements IPaymentRecordService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> selectPaymentPage(Page<PaymentRecord> page, PaymentRecord paymentRecord) {
        return baseMapper.selectPaymentPage(page, paymentRecord);
    }
}
